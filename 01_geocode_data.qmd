...
```{r}
data.table::fwrite(df_montreal, file = "data/montreal_geolocated_complete.csv")
data.table::fwrite(df_montreal_filter, file = "data/montreal_geolocated_filtered.csv")
sf::st_write(df_montreal_filter_sf, "data/df_montreal_filter_sf.gpkg", append = F)
```
