...
survey_filter_cd <- survey_filter_cd %>% 
  mutate(
    ...
    , has_vehicle_household = as_factor(case_when(
      q39 == "0" ~ "No"
      , q39 == "Prefer not to answer" ~ NA_character_
      , .default = "Yes"
    ))
...
survey_filter_cd <- survey_filter_cd %>% 
  mutate(
    ...
    , has_free_pass_categories = as_factor(case_when(
...
```{r saverdata}
save(montreal_cd_ct, file = "data/montreal_cd_ct.RData")
save(montreal_fsa, file = "data/montreal_fsa.RData")
save(survey_filter_cd, file = "data/survey_filter_cd.RData")
